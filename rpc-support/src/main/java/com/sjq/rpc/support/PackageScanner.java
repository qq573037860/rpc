...
public class PackageScanner {
    ...
    public static List<Class> scanInterfaceByPackagePathAndAnnotation(String packagePath, Class[] annotations) {
        ...
        try {
            ...
            throw new RpcException(RpcException.INTERRUPTED_EXCEPTION, "scanInterfaceByPackagePathAndAnnotation failed", e);
        }
    }
    ...
    public static List<Class> scanClassByPackagePathAndAnnotation(String packagePath, Class[] annotations) {
        ...
        try {
            ...
            throw new RpcException(RpcException.INTERRUPTED_EXCEPTION, "scanClassByPackagePathAndAnnotation failed", e);
        }
    }
